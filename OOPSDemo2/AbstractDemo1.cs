...
namespace OOPSDemo2
{
    // In the below example, we calculate the electricity
    //bills for commercial and domestic plans usingabstract class and abstract methods.
  ...
  public abstract  class Plan
    {
        ...
        public void calculation(int units)
        {
            ...
            Console.Write("Bill amount for {0} units is:" +
                "{1}",units,bill);
        }
    }
